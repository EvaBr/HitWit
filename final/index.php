...
$(document).ready(function(){
  ...
  $("#next1, #next2, #next3, #next4").click(function(){
...
//  $("#next1").click(function(){ // When you click on button #next1...
  ...
  $("#prev2, #prev3, #prev4, #prev5").on('click',function(){
    var index = $("#accordion").accordion('option', 'active');
...
function checkFirst(kder){ //returns true, if some data is missing. in that case, user is to be alerted.
  ...
  switch(kder) {
    ...
    case 3:
      ...
      break;
    //case 4: THIS IS FOR THE SUBMIT BUTTON! AND THUS DONE IN ONSUBMISSION();
    default:
      break;
  };
  return (!result);
...
For more details, please visit the <a class="urls" href="..drugaStran/stochprofdata.php">Stochastic Profiling Webpage</a>.
For questions and suggestions, please contact
<a class="urls" href="https://www.helmholtz-muenchen.de/icb/institute/staff/staff/ma/2448/index.html" >Christiane Fuchs.</a>
</p> </center>
...
<div>
  <p>
    ...
    <button type="button" id="prev5" style="float: right;"> Previous </button>
    <br>
  </p>
</div>
</div>
...
<br><br><br>
<div style="display: none; margin-left: 14.8em; width: 77%;" id="helmholtz_logo"><img src="logo_institut.svg"></div> <br>
<!--margin-left: 2.5em;-->
<center>
